    ...
    | ManualKeyDown key -> // Needed for e.g. Ctrl + C and Ctrl + V as they are not picked up by Electron
        ...
        let newCmd =
            ...
            | true ->
                ...
                elif containsKey "SHIFT" newPressedKeys && containsKey "Z" newPressedKeys then
                    sheetCmd (KeyPress CtrlY)
                elif containsKey "Z" newPressedKeys then
                    sheetCmd (KeyPress CtrlZ)
                elif containsKey "Y" newPressedKeys then
                    sheetCmd (KeyPress CtrlY)
