...
let viewInfoPopup dispatch =
    ...
    let about = div [] [
        ...
        br []; br []
        makeH "Project History"
        str "Issie Web is the browser-focused continuation of the original Issie project. This repository keeps the F# / Fable editor and simulator core while replacing Electron and Node runtime integrations with browser-safe shims, browser file dialogs, GitHub Pages deployment, and browser session recovery."
        br []; br [] 
        makeH "Technology"
        Text.span [] [
            str "Issie Web is written in "
            ...
            str " and bundled as a static browser application for GitHub Pages." 
            ]    
        ]
    ...
    let intro = div [] [
        ...
        br []  ; br [];  
        button 
            [OnClick <| openInBrowser "https://github.com/LWZsama/issie-web"] 
            [ str "Open the issie-web repository"]
        br [] ; br [] ]
    ...
    let keys =
        ...
        div [] [
            ...
            div
                [Style [FontStyle "Italic"]]
                [str "Note: keyboard shortcuts are limited by the browser and operating system."]
            keyTable
        ]
